...
<style>
  ...
  <?php include("modal.php"); ?>
      ...
      <h1 style="font-family: Dosis;text-align: center;font-size: 30px;"><i class="fas fa-headphones"></i> Electronics</h1></div>
             <!-- post right here -->

     <?php 

    $query=mysqli_query($connection,"SELECT * FROM tbl_trade WHERE categories='Electronic'");
