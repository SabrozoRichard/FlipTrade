...
<style>
  ...
  <?php include("modal.php"); ?>
      ...
      <h1 style="font-family: Dosis;text-align: center;font-size: 30px;"><i class="fas fa-car"></i> Vehicle</h1></div>
             <!-- post right here -->

     <?php 

    $query=mysqli_query($connection,"SELECT * FROM tbl_trade WHERE categories='Vehicles'");
